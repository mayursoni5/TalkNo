...
function NewDm() {
  const { setSelectedChatType, setSelectedChatData, onlineUsers } =
    useAppStore();
                  ...
                  >
                    <div className="relative">
                      ...
                      {onlineUsers.has(contact._id) && (
                        <div className="absolute -bottom-0 -right-0 w-3 h-3 bg-green-500 rounded-full border-2 border-[#181920]"></div>
                      )}
                    </div>
